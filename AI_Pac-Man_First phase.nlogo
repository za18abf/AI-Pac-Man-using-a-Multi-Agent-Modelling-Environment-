...
to move-pacman  ;; Observer Procedure
  ...
  [
    consume
    let pacman-dirs clear-pacman-headings ;; this procedure is called to get the Pacman moving in the patch
    set heading one-of pacman-dirs
     fd 1
    consume
...
to-report clear-pacman-headings ;; pacman procedure ;;this procedure has been used to check the surrounding for black patch tile and report it back
  let dirs []
